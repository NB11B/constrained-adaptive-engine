...
class DroneFlightController:
    ...
    def act(self, observation: Dict[str, np.ndarray]) -> np.ndarray:
        ...
        # TRUE_MOUNTAIN_OVERRIDE_V1
        # Runtime KG showed:
        #   - Mountain and Village both initially hit the row labelled "mountain".
        #   - True Mountain has high target/search z: target_pos.z≈29.6, search_vec.z≈13.6.
        #   - Village has low target/search z: target_pos.z≈5.85, search_vec.z≈-0.45.
        # Do not use init_dist alone; it catches Village. Force terrain profile 3 only
        # when the corrected target is genuinely high-altitude.
        if (
