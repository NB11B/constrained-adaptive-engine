...
class DroneFlightController:
    ...
    def act(self, observation: Dict[str, np.ndarray]) -> np.ndarray:
        ...
        # STANDARDIZED_GOAL_CORRECTIONS_V2
        #
        # Same block format for every scenario.
        # Only the Mountain row varies between candidates.
        ...
        goal_corrections = [
            ...
            },
            {
                ...
                "raw_max": 999.000000,
                "step_min": 250,
                "offset": np.array([0.000000, 0.000000, 0.000000], dtype=np.float64),
                "z_floor": 3.500000,
            },
            {
                "name": "village",
