...
class DroneFlightController:
    ...
    def act(self, observation: Dict[str, np.ndarray]) -> np.ndarray:
        ...
        # RUNTIME_GOAL_CORR_TRACE_KG_V2
        # Direct trace at the exact code-flow edge:
        # goal_corrections -> target_pos/dist_xy -> terrain inference.
        if (
            ...
            try:
                ...
                sys.stderr.write("CAE_GOAL_TRACE " + json.dumps(_kg_payload, separators=(",", ":")) + "\n")
                sys.stderr.flush()
            except Exception:
                pass
