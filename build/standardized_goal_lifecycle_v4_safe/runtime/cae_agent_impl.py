...
class DroneFlightController:
    ...
    def act(self, observation: Dict[str, np.ndarray]) -> np.ndarray:
        ...
        # STANDARDIZED_GOAL_CORRECTIONS_V4_SAFE
        #
        # Same block format for each scenario.
        # v4 intentionally standardizes only the goal-correction layer.
        # Existing proven terminal handling remains intact for non-Mountain maps.
        ...
        goal_corrections = [
            ...
            {
                # Mountain now has the same format, but its terminal assist is
                # Mountain-local only. We do not globalize terminal handling.
                "name": "mountain",
                "init_min": 40.0,
                "init_max": 50.0,
                "raw_min": 20.0,
            ...
            {
                # Preserve the v1 Village improvement path explicitly.
                "name": "village",
                "init_min": 40.0,
                "init_max": 50.0,
                "raw_min": 10.0,
        ...
        # MOUNTAIN_LOCAL_TERMINAL_LIFECYCLE_V4
        #
        # Mountain-only terminal assist. This is deliberately not applied to
        # City/Open/Forest/Village, because v3 proved global terminal replacement
        # destroys known-good paths.
        if (
